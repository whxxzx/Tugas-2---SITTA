...
filteredTracking() {
    ...
    return Object.entries(this.trackingList)
    .filter(([key, item]) => {
    ...
    Swal.fire({
        ...
        <div class="tracking-detail">
            ...
            <div class="tracking-header">
                ...
                <span class="${this.statusClass(item.status)} tracking-badge">
                    ${item.status}
                </span>
